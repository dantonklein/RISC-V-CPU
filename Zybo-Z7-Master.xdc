...
create_clock -add -name sys_clk_pin -period 11.766 -waveform {0 5.883} [get_ports { clk }];


##Switches
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { debug_enable }]; #IO_L19N_T3_VREF_35 Sch=sw[0]
...
##LEDs
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { data_access_fault_exception }]; #IO_L23P_T3_35 Sch=led[0]
